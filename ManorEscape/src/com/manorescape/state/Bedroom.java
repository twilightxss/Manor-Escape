...
public class Bedroom extends LevelState
{
    ...
    private final int xCoords[] = {100, 525, 525, 175, 250, 225};
    private final int yCoords[] = {100, 150, 100, 475, 475, 400};
    private final String furnitureType[] = {"table", "table" , "table", "table", "table", "table"};
    
    private TileMapManager tmm;
    private TileMap tm;
    
    public Bedroom(LevelManager lm)
    {
        super(lm);
        ...
        e = new Enemy(tmm, 500, 300, 10);
        //k = new Key(tmm, 450, 500);
    ...
    public void init()
    {
        ...
        System.out.println("Bedroom loaded");
    }
